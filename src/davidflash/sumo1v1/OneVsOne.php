...
use davidflash\sumo1v1\commands\OneVsOneCommand;
use davidflash\sumo1v1\math\Vector3;
use davidflash\sumo1v1\provider\YamlDataProvider;
...
class OneVsOne extends PluginBase implements Listener {
    ...
    public function onEnable() {
        ...
        $this->getServer()->getCommandMap()->register("sumo", $this->commands[] = new OneVsOneCommand($this));
    }
    ...
    public function onChat(PlayerChatEvent $event) {
        ...
        switch ($args[0]) {
            case "help":
                $player->sendMessage("§a> Sumo setup help (1/1):\n".
    ...
    public function joinToRandomArena(Player $player) {
        ...
        $player->sendMessage("§c> All arenas are full!");
    }
}