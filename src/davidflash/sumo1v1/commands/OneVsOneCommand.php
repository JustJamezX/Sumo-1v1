...
class OneVsOneCommand extends Command implements PluginIdentifiableCommand {
    ...
    public function __construct(OneVsOne $plugin) {
        $this->plugin = $plugin;
        parent::__construct("sumo1v1", "Sumo commands", \null, ["sumo"]);
    }
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args) {
        ...
        switch ($args[0]) {
            case "help":
                ...
                $sender->sendMessage("§a> Sumo commands:\n" .
                    "§7/sumo help : Displays list of Sumo commands\n".
                    "§7/sumo create : Create Sumo arena\n".
                    "§7/sumo remove : Remove Sumo arena\n".
                    "§7/sumo set : Set Sumo arena\n".
                    "§7/sumo arenas : Displays list of arenas\n" .
                    "§7/sumo join : Connect player to the random arena");
            ...
            case "create":
                ...
                if(!isset($args[1])) {
                    $sender->sendMessage("§cUsage: §7/sumo create <arenaName>");
                    break;
                }
            ...
            case "remove":
                ...
                if(!isset($args[1])) {
                    $sender->sendMessage("§cUsage: §7/sumo remove <arenaName>");
                    break;
                }
                if(!isset($this->plugin->arenas[$args[1]])) {
            ...
            case "join":
                ...
                break;
            case "credits":
                    $sender->sendMessage("§a> Sumo1v1:\n" .
                        "§7Plugin vytvořen David Flash\n".
                        "§7Majitel serveru Flash Craft 2\n".
                        "§7Hdoně kodu použito z pluginu\n".
                        "§71vs1 od GamakCZ\n".
                        "§7Děkuji za stažení pluginu!");
        }
